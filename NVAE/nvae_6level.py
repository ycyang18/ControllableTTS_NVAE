...
from NVAE.utils import add_sn, Swish, ChannelSELayer1d, reparameterize, kl, kl_2
...
class NVAE_L6(nn.Module):
    ...
    def forward(self, x):
        ...
        recon_mix_loss  = 0.1 * torch.nn.functional.l1_loss(x_hat, x) + \
...
#x_hat, recon_mse_loss, recon_mix_loss, recon_sigmoid_loss, kl_avg_loss, kl_sum_loss, losses, enc_kl_loss = vae(rand_embedding)
