...
from nvae_6level_mod2 import NVAE_L6_mod
...
wandb.init(
    ...
    config={
        ...
        "scheduler_rate":0.0,
        "recon_loss":'weighted_sum', #last, sum, avg
...
def train(
    ...
    for epoch in range(epochs):
        ...
        if epoch % 100 == 0:
            torch.save(model.state_dict(), f"checkpoint_mod2/{exp_name}_ep{epoch}.pt")
    ...
    torch.save(model.state_dict(), f"checkpoint_mod2/{exp_name}.pt")
