...
class BaseModel(torch.nn.Module):
    # /Models/EmbeddingVAE/embedding_vae.pt
    # /mount/studenten/arbeitsdaten-studenten1/yangyg/IMS-Toucan/embedding_function.pt
    # /mount/studenten/arbeitsdaten-studenten1/yangyg/StochasticTTS/EmbeddingVAE/embedding_vae.pt
    #def __init__(self, path_to_weights=None, bottleneck_size=16, device="cpu"):
